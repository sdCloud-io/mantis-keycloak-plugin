...
<div class="position-relative">
	...
	<form id="login-form" method="post" action="<?php echo AUTH_PAGE_CREDENTIAL ?>">
		<fieldset>
            ...
            <a class="width-40 pull-right btn btn-success btn-inverse bigger-110" style="margin-left: 20px" href="http://<keycloak-server>/auth/realms/<realm-name>/protocol/openid-connect/auth?client_id=<client-id>&redirect_uri=<redirect-uri>&state=<state>&response_type=code&scope=openid"> Login with SSO </a>
